...
To learn more, please visit the [Getting Involved]({{% relref "/docs/getting-involved" %}}) page, and feel free to contact us at fair@comses.net to share any additional ideas or interest.


## Navigating the site
This website's documentation pages provide information on the [process]({{% relref "/docs/process" %}}) involved in making a model FAIR, the currently-selected papers and their associated [models]({{% relref "/docs/models" %}}), and the steps for [getting involved]({{% relref "/docs/getting-involved" %}}) with this initiative. Additionally, be sure check out the [community discussion board](https://github.com/orgs/make-models-fair/discussions) on Github.
